...
extract($_POST);
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if (empty($messages)) {
            ...
            $db = dbConn();              
            $adddate = date('Y-m-d');
            echo $sql = "INSERT INTO inquiries(ClientName,ClientMobile, ClientEmail, ServiceID, ClientMessage, 
...
echo "<br>";
    ...
    <body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px;
        ...
        Swal.fire({
            ...
            window.location.href = 'https://pereraseneviratne.lk/quote.php'; // Redirect to success page
        });
</script>";
